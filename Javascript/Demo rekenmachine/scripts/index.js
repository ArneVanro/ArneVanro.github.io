...
const aftrekken = () => {
	...
	let textLinks = document.getElementById("txtLinks");
	let textRechts = document.getElementById("txtRechts");

	let g1=parseInt(textLinks.value, 10);
	let g2=parseInt(textRechts.value, 10);
	let resultaat = g1 - g2;

	let resultaatTekst = g1 + " - " + g2 + " = "+resultaat;
	textOutput.innerHTML = resultaatTekst;
